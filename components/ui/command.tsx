...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      ...
      <DialogContent className="overflow-hidden rounded-3xl p-4">
...
function CommandInput({
  ...
  return (
    <div
      ...
      className={cn(
        "flex h-9 w-full items-center gap-2 px-3",
        wrapperClassName,
      )}
    >
      {showSearchIcon && <SearchIcon className="size-5 shrink-0 opacity-50" />}
